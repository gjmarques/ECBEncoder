...
HD_PWD='D:/Files/ECBEncoder/ECBEncoder/stream/stream.runs/mb_design_CustomECBEncoder_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_design_CustomECBEncoder_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_design_CustomECBEncoder_0_0.tcl
