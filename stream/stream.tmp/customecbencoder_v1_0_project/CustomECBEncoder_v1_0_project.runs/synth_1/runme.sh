...
HD_PWD='d:/files/ecbencoder/ecbencoder/stream/stream.tmp/customecbencoder_v1_0_project/CustomECBEncoder_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CustomECBEncoder_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CustomECBEncoder_v1_0.tcl
