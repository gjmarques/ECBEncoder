...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../stream.srcs/sources_1/bd/mb_design/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../stream.srcs/sources_1/bd/mb_design/ipshared/4fba" \
       +incdir+"../../../../stream.srcs/sources_1/bd/mb_design/ipshared/ec67/hdl" \
       +incdir+"../../../../stream.srcs/sources_1/bd/mb_design/ipshared/4fba"
}
