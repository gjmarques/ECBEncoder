...
proc create_root_design { parentCell } {
  ...
  # Create instance: CustomECBEncoder_1, and set properties
  set CustomECBEncoder_1 [ create_bd_cell -type ip -vlnv xilinx.com:user:CustomECBEncoder:1.0 CustomECBEncoder_1 ]
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net CustomECBEncoder_1_M00_AXIS [get_bd_intf_pins CustomECBEncoder_1/M00_AXIS] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  ...
  connect_bd_intf_net -intf_net axis_data_fifo_0_M_AXIS [get_bd_intf_pins CustomECBEncoder_1/S00_AXIS] [get_bd_intf_pins axis_data_fifo_0/M_AXIS]
