...
-- Date        : Sat Jul 11 23:26:55 2020
-- Host        : LAPTOP-KJ99TN5H running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               D:/Files/ECBEncoder/ECBEncoder/dma/dma.srcs/sources_1/bd/mb_design/ip/mb_design_CustomECBEncoder_1_0/mb_design_CustomECBEncoder_1_0_sim_netlist.vhdl
-- Design      : mb_design_CustomECBEncoder_1_0
...
entity mb_design_CustomECBEncoder_1_0_ECBEncoder is
  port (
    D : out STD_LOGIC_VECTOR ( 15 downto 0 );
    s00_axis_tdata : in STD_LOGIC_VECTOR ( 21 downto 0 )
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of mb_design_CustomECBEncoder_1_0_ECBEncoder : entity is "ECBEncoder";
end mb_design_CustomECBEncoder_1_0_ECBEncoder;

architecture STRUCTURE of mb_design_CustomECBEncoder_1_0_ECBEncoder is
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity mb_design_CustomECBEncoder_1_0_CustomECBEncoder_v1_0_S00_AXIS is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of mb_design_CustomECBEncoder_1_0_CustomECBEncoder_v1_0_S00_AXIS : entity is "CustomECBEncoder_v1_0_S00_AXIS";
end mb_design_CustomECBEncoder_1_0_CustomECBEncoder_v1_0_S00_AXIS;

architecture STRUCTURE of mb_design_CustomECBEncoder_1_0_CustomECBEncoder_v1_0_S00_AXIS is
...
ecbencoder_inst: entity work.mb_design_CustomECBEncoder_1_0_ECBEncoder
     port map (
      D(15) => s_ciphered_text00_out(15),
      D(14) => s_ciphered_text00_out(13),
      D(13) => s_ciphered_text00_out(11),
      D(12 downto 10) => s_ciphered_text00_out(9 downto 7),
      D(9) => s_ciphered_text00_out(5),
      D(8) => s_ciphered_text00_out(3),
      D(7 downto 6) => s_ciphered_text00_out(1 downto 0),
      D(5) => s_cypher(14),
      D(4) => s_cypher(12),
      D(3) => s_cypher(10),
      D(2) => s_cypher(6),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity mb_design_CustomECBEncoder_1_0_CustomECBEncoder_v1_0 is
  port (
    m00_axis_tdata : out STD_LOGIC_VECTOR ( 31 downto 0 );
    m00_axis_tstrb : out STD_LOGIC_VECTOR ( 3 downto 0 );
    s00_axis_tready : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of mb_design_CustomECBEncoder_1_0_CustomECBEncoder_v1_0 : entity is "CustomECBEncoder_v1_0";
end mb_design_CustomECBEncoder_1_0_CustomECBEncoder_v1_0;

architecture STRUCTURE of mb_design_CustomECBEncoder_1_0_CustomECBEncoder_v1_0 is
begin
CustomECBEncoder_v1_0_S00_AXIS_inst: entity work.mb_design_CustomECBEncoder_1_0_CustomECBEncoder_v1_0_S00_AXIS
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity mb_design_CustomECBEncoder_1_0 is
  port (
    s00_axis_aclk : in STD_LOGIC;
    s00_axis_aresetn : in STD_LOGIC;
    s00_axis_tready : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of mb_design_CustomECBEncoder_1_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of mb_design_CustomECBEncoder_1_0 : entity is "mb_design_CustomECBEncoder_1_0,CustomECBEncoder_v1_0,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of mb_design_CustomECBEncoder_1_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of mb_design_CustomECBEncoder_1_0 : entity is "CustomECBEncoder_v1_0,Vivado 2019.2";
end mb_design_CustomECBEncoder_1_0;

architecture STRUCTURE of mb_design_CustomECBEncoder_1_0 is
...
begin
U0: entity work.mb_design_CustomECBEncoder_1_0_CustomECBEncoder_v1_0
     port map (
      m00_axis_tdata(31 downto 0) => m00_axis_tdata(31 downto 0),
      m00_axis_tlast => m00_axis_tlast,
      m00_axis_tready => m00_axis_tready,
