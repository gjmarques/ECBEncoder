...
HD_PWD='D:/Files/ECBEncoder/ECBEncoder/dma/dma.runs/mb_design_CustomECBEncoder_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_design_CustomECBEncoder_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_design_CustomECBEncoder_1_0.tcl
