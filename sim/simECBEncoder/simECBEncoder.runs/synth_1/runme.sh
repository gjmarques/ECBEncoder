...
HD_PWD='D:/Files/ECBEncoder/ECBEncoder/sim/simECBEncoder/simECBEncoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ECB_tb2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ECB_tb2.tcl
