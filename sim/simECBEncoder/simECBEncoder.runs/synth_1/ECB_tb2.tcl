...
synth_design -top ECB_tb2 -part xc7a35tcpg236-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef ECB_tb2.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file ECB_tb2_utilization_synth.rpt -pb ECB_tb2_utilization_synth.pb"
